...
const LicenseManagement = () => {
  ...
  const handleDownload = license => {
    ...
    doc.text(
      `Date of Birth: ${
        license.dob ? new Date(license.dob).toLocaleDateString() : 'N/A'
      }`,
      20,
      60,
    );
    ...
    doc.text(
      `Vehicle Class: ${license.vehicleClass?.join(', ') || 'N/A'}`,
      20,
      80,
    );
    ...
    doc.text(
      `Education: ${basicInfo.educationalQualification || 'N/A'}`,
      20,
      140,
    );
